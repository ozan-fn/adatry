...
export const AnimatedThemeToggler = ({ className, duration = 400, ...props }: AnimatedThemeTogglerProps) => {
    ...
    return (
        <button ref={buttonRef} onClick={toggleTheme} aria-label="Toggle theme" className={cn("text-text-primary relative flex h-9 w-9 items-center justify-center rounded-lg bg-transparent shadow-none transition-all hover:bg-neutral-100 dark:text-white dark:hover:bg-neutral-800", className)} {...props}>
